...
Configurable daemon behaviors:
   ...
   1.) The current working directory set to the "/home/cmpsc311assign3" directory.
   2.) The current file creation mode mask set to 0.
   3.) Close all open files (1024). 
   4.) Redirect standard I/O streams to "/dev/null". // not the case, as stdout and stderr are handled by server script JC 11/08/15
...
WORKDIR = "/home/cmpsc311assign3"

# Default maximum for the number of available file descriptors.
MAXFD = 1024

# stdout and stderr already handled by server script - JC 11/08/15
